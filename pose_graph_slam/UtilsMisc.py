...
class PoseGraphResultSaver:
    def __init__(self, init_pose, save_gap, num_frames, save_dir):
    ...
    def vizCurrentTrajectory(self, fig_idx):
        ...
        plt.clf()
        plt.plot(x, y, color=plt.cm.rainbow(500/1444), linewidth=5.0)